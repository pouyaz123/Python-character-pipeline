...
DESCRIPTION = 'This module provides stretchy IK on the joint chain, with the ability to lock the stretchiness with a 0->1 slider value. Note: ik handle is not space-switchable, and for hat reason, has frozen transformations at its creation position'

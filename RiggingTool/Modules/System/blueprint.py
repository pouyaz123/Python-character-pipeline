...
class Blueprint():
	...
	def lock_phase1(self):
		...
		#
		#moduleInfo = (jointPositions,jointOrientations,jointRotationOrders,jointPrefferedAngles, hookObject,rootTransform)
		#return moduleInfo
		return None
	...
	def mirror_custom(self, originalModule):
		print 'mirror_custom() method is not imlemented by drived class'
